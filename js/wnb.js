/*
软件名称:蜗牛吧
下载链接https://h5.snail2020.com/index/bindInvite?inviteCode=9dnjJA6d
更新时间：2021-03-01 @jim114042
脚本说明：自动领取红包，领取广告金币 参考其他大佬修改，在此感谢大佬
...
注意:
蜗牛吧下载请复制下方链接下载
https://h5.snail2020.com/index/bindInvite?inviteCode=9dnjJA6d
...
[task_local]
#蜗牛吧
15,45 10-22 * * * https://raw.githubusercontent.com/jim114042/quanx/main/js/wnb.js, tag=蜗牛吧, img-url=https://ftp.bmp.ovh/imgs/2021/02/221a7d94eaa0dddf.jpeg, enabled=true


[rewrite_local]
#蜗牛吧
^https://api.snail2020.com/api/hb/hb/ url script-request-body https://raw.githubusercontent.com/jim114042/quanx/main/js/wnb.js



#loon
^https://api.snail2020.com/api/hb/hb/ script-path=https://raw.githubusercontent.com/jim114042/quanx/main/js/wnb.js, requires-body=true, timeout=10, tag=蜗牛吧



#surge

蜗牛吧 = type=http-request,pattern=^https://api.snail2020.com/api/hb/hb/,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/jim114042/quanx/main/js/wnb.js,script-update-interval=0
...
function wnbhby( timeout = 0){//城市红包雨
  return new Promise((resolve) => {
    let url = {
        url : 'https://api.snail2020.com/api/hb/hb/receiveSystem',
        headers : JSON.parse($.getdata('wnbhd')),
        body :  `district=${$.getdata('wnbdistrict')}&type=default`,}
...
function wnbhby2(t, timeout = 0){
  return new Promise((resolve) => {
let url = {
        url : `https://api.snail2020.com/api/hb/hb/getSystemInfo?id=${t.id}&type=default`,
        headers : JSON.parse($.getdata('wnbhd')),
        body :  ``,}
      $.get(url, async (err, resp, data) => {
        try {
